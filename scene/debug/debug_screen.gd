...
@onready var _ref_SeedLineEdit: CustomLineEdit = $DebugVBox/SettingGrid/SeedLineEdit
@onready var _ref_WizardLineEdit: CustomLineEdit = $DebugVBox/SettingGrid/WizardLineEdit
@onready var _ref_MapLineEdit: CustomLineEdit = $DebugVBox/SettingGrid/MapLineEdit
