...
static func create_sprite(
	main_tag: StringName, sub_tag: StringName, coord: Vector2i, send_signal: bool
) -> TaggedSprite:
...
static func create_ground(sub_tag: StringName, coord: Vector2i, send_signal: bool) -> TaggedSprite:
	return create_sprite(MainTag.GROUND, sub_tag, coord, send_signal)


static func create_trap(sub_tag: StringName, coord: Vector2i, send_signal: bool) -> TaggedSprite:
	return create_sprite(MainTag.TRAP, sub_tag, coord, send_signal)


static func create_building(sub_tag: StringName, coord: Vector2i, send_signal: bool) -> TaggedSprite:
	return create_sprite(MainTag.BUILDING, sub_tag, coord, send_signal)


static func create_actor(sub_tag: StringName, coord: Vector2i, send_signal: bool) -> TaggedSprite:
