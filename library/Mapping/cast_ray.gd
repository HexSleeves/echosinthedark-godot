...
static func get_coords(
	source_coord: Vector2i, target_coord: Vector2i, is_obstacle: Callable, is_obstacle_args: Array
) -> Array:
	var direction: Vector2i = ConvertCoord.get_direction(source_coord, target_coord)
