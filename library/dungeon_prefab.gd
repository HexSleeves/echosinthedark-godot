...
static func get_prefab(output_line: Dictionary, transforms: Array) -> PackedPrefab:
...
static func _flip_horizontally(prefab: Dictionary, max_x: int, max_y: int) -> Dictionary:
	var mirror: int
...
static func _flip_vertically(prefab: Dictionary, max_x: int, max_y: int) -> Dictionary:
	var mirror: int
...
static func _rotate_right(prefab: Dictionary, max_x: int, max_y: int) -> Dictionary:
...
static func _rotate_left(prefab: Dictionary, max_x: int, max_y: int) -> Dictionary:
	var new_prefab: Dictionary = _get_new_matrix(max_x, max_y)
	var new_x: int
	var new_y: int
...
static func _swap_matrix_value(matrix: Dictionary, this_coord: Vector2i, that_coord: Vector2i) -> void:
