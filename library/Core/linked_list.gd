...
static func insert_object(new_object: Object, next_object: Object, linked_list: Dictionary) -> bool:
...
static func append_object(new_object: Object, previous_object: Object, linked_list: Dictionary) -> bool:
...
static func get_previous_object(object: Object, linked_list: Dictionary) -> Object:
	if _warn_no_object(object, linked_list):
		return null
	var this_id: int = object.get_instance_id()
	var this_linked: LinkedObject = linked_list[this_id]
