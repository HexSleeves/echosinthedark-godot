...
static func _set_wizard_mode(setting: Dictionary) -> void:
	var setting_value: SettingValue = _parse_setting(setting, WIZARD_MODE, VALUE_TYPE.BOOL)
...
static func _set_show_full_map(setting: Dictionary) -> void:
	var setting_value: SettingValue = _parse_setting(setting, SHOW_FULL_MAP, VALUE_TYPE.BOOL)
	if setting_value.is_valid:
		TransferData.set_show_full_map(setting_value.bool_value)


static func _set_rng_seed(setting: Dictionary) -> void:
	var setting_value: SettingValue = _parse_setting(setting, RNG_SEED, VALUE_TYPE.INT)
	var rng_seed: int
...
static func _set_palette(setting: Dictionary) -> void:
	var setting_value: SettingValue = _parse_setting(setting, PALETTE, VALUE_TYPE.DICTIONARY)
...
static func _parse_setting(setting: Dictionary, key: String, value_type: int) -> SettingValue:
